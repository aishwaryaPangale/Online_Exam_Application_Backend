...
//    attended test
    ...
    public Map<String, Integer> getAttendedStudentCount() {
        Map<String, Integer> response = new HashMap<>();
        response.put("count", regService.getAttendedStudentCount());
        return response;
    }
//not Attended Test
    @GetMapping("/not-attended/count")
    public Map<String, Integer> getNotAttendedStudentCount() {
        Map<String, Integer> response = new HashMap<>();
        response.put("count", regService.getNotAttendedStudentCount());
        return response;
    }
    //test Score
